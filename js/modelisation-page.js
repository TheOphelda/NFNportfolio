const BASSAM_SKETCHUP = Array.from({ length: 4 }, (_, i) => ({
  src: `images/autres projets/Villa Bassam/VISUALISATION SKETCHUP/sketchup-${i + 1}.jpeg`,
  title: `Villa Bassam — SketchUp ${i + 1}`
}));
...
renderGallery('gallery-bassam', BASSAM_SKETCHUP);
